...
function Event({ type, event, eventWidth }) {
	...
	return (
		...
		>
			...
			<div className="height-100 font-13 bold-font text-elip" style={{ width: '90%' }}>{event.name}</div>
			<div className="light-color height-100 font-12 text-elip" style={{ width: '90%' }}>{event.title}hello</div>
			{IconDisplay()}
		</div >
	);
}
